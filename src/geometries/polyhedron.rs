use crate::{models::common::Position, utils::math::pow};
...
impl Icosahedron {
    pub fn new() -> Self {
        ...
        ico.get_unit_vectors();
        ico.get_triangle_arc_lengths();
        ico
    }
    pub fn get_center_faces_icosahedron() -> Vec<Position> {
    ...
    fn get_triangle_arc_lengths(&mut self) {
        let uvs = &self.triangle_uvs;
        let dot_ab = 0.0;
        self.triangle_arcs.ab =
            f64::acos( dot_ab);
